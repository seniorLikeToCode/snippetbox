...
import (
	...
	"snippet.abhishek/internal/validator"
)
...
func (app *application) snippetView(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, http.StatusOK, "show.page.tmpl", data)
}
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// Validate and use the data as normal...
	form.CheckField(validator.NotBlank(form.Title), "title", "This field cannot be blank")
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "This field cannot be more than 100 characters long")
	form.CheckField(validator.NotBlank(form.Content), "content", "This field cannot be blank")
	form.CheckField(validator.PermittedInt(form.Expires, 1, 7, 365), "expires", "This field must equal 1, 7 or 365")

	// If there are any errors, dump them in a plainn text HTTP response and
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// check whether the creds are valid
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	// Remove th authenticatedUserID from the session data so that the user is
	// `logged out`
